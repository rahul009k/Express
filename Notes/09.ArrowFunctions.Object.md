...
Arrow functions can return objects when the object is wrapped in parentheses.

---

## ❓ Why it was introduced

This avoids confusion with function body braces.
...
- Parentheses make JavaScript treat the braces as an object literal.
